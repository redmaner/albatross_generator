...
config :albagen,
  ...
  new_account_min_nim: System.get_env("NEW_ACCOUNT_MIN_NIM", "1") |> String.to_integer(),
  new_account_max_nim: System.get_env("NEW_ACCOUNT_MAX_NIM", "1000") |> String.to_integer(),
  stakers_to_create: System.get_env("STAKERS_TO_CREATE", "500") |> String.to_integer(),
  timer_cap_in_secs:
    System.get_env("TIMER_CAP_IN_SECS", "480")
    |> String.to_integer()
    |> :timer.seconds()
